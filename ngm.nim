...
import ngm/[util, vector, matrix, quat, dquat, rect, triangle, circle, interpolation, camera, colours]
export      util, vector, matrix, quat, dquat, rect, triangle, circle, interpolation, camera, colours
