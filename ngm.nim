...
import ngm/[util, vector, matrix, quat, dquat, rect, line, triangle, circle, polygon, interpolation, camera, colours]
export      util, vector, matrix, quat, dquat, rect, line, triangle, circle, polygon, interpolation, camera, colours
